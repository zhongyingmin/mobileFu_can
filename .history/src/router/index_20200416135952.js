...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      {
        path: 'orders/applyRefund',
        name: '申请退款',
        component: () => import('@/views/personal/orders/applyRefund'),
        meta: {
          requiresAuth: true
        }
      },
      {
        path: 'orders/detailsRefund',
        name: '退款详情',
        component: () => import('@/views/personal/orders/detailsRefund'),
        meta: {
          requiresAuth: true
        }
      },
      {
        path: 'orders/refundAfter',
        name: '退款售后',
