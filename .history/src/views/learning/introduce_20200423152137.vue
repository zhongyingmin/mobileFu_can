  ...
  <div class="introduce">
    ...
    <div class="body">
      ...
      <div class="introduce-wrapper">
        ...
        <div class="enter"@click="goPath('/book/content')">进入阅读</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    init(div) {
      ...
      a.innerHTML =
        content.length > len
          ? "<div style='padding-right: 8px;font-size:14px;wight:100%;text-align:center'><i class='iconfont iconxia' style='font-size:18px'></i>展开全部</div>"
      ...
      a.onclick = function() {
        if (a.innerHTML.indexOf("展开") > 0) {
          //如果a中含有"展开"则显示"收起"
          a.innerHTML =
            "<div style='padding-right: 8px;font-size:14px;wight:100%;text-align:center'><i class='iconfont iconxia' style='font-size:18px;display: -webkit-inline-box;transform: rotate(180deg);'></i>收起</div>";
