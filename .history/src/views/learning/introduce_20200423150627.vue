...
export default {
  ...
  methods: {
    ...
    init(div) {
      ...
      a.innerHTML =
        content.length > len
          ? "<div style='font-size:14px'><i class='iconfont iconxia' style='font-size:18px'></i>展开全部</div>"
      ...
      a.onclick = function() {
        if (a.innerHTML.indexOf("展开") > 0) {
          ...
          a.innerHTML = "<div style='font-size:14px;wight:100%;text-align:center'><i class='iconfont iconxia'></i>展开全部</div>";
