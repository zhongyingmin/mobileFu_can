...
export default {
  ...
  methods: {
    ...
    init(div) {
      ...
      a.innerHTML =
        content.length > len
          ? "<span style='font-size:14px'><i class='iconfont iconxia' style='font-size:18px'></i>展开全部</span>"
      ...
      a.onclick = function() {
        if (a.innerHTML.indexOf("展开") > 0) {
          ...
          a.innerHTML = "<span style='font-size:14px'><i class='iconfont iconxia'></i>展开全部</span>";
