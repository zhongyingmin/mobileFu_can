    ...
    <div class="mall_body">
      <div class="mall_head">
        ...
        <div class="head_swiper_div">
          <van-swipe class="head_swipe" :autoplay="5000" v-show="state === 1">
            <van-swipe-item v-for="(image, index) in images" :key="index">
              <img v-lazy="image" />
            </van-swipe-item>
          </van-swipe>
          <van-swipe class="head_swipe_plus" :autoplay="5000" v-show="state != 1">
            <van-swipe-item v-for="(image, index) in images" :key="index">
              <img v-lazy="image" />
            </van-swipe-item>
          </van-swipe>
          <div class="doctor" v-show="state === 1">
        ...
        <van-grid
          :class="state === 1 ? 'h_order_grid_item' : 'h_order_grid_item_plus'"
          :column-num="5"
        >
          <van-grid-item
