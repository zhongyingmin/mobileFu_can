    ...
    >
      <van-tab title="全部库存">
        <div class="i-tab_content">
          <div class="item" @click="goPath('/mall/myPharmacy/info')">
            <div>
              <div>药材名称：艾叶</div>
              <div>数量：30</div>
            </div>
        ...
        <div class="i-tab_content_two">
          ...
          <div class="footer_c">
            <div class="footer_options" v-show="state_op==1">
              ...
              <span @click="goPath('/mall/myPharmacy/replenishment')">一键补货</span>
            </div>
        ...
        <div class="i-tab_content">
          <div class="item">
            <div>
              <div>药材名称：艾叶</div>
              <div>
                <div class="right_title">超出有效期</div>
                <div>数量：30</div>
              </div>
            </div>
            <div>
    ...
    cg(row) {
      if (!row.isSelected) {
        if (this.multipleSelection.length > 0) {
          this.multipleSelection.forEach((element, key) => {
            if (this.multipleSelection[key].id == row.id) {
