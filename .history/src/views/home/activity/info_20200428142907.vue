...
export default {
  ...
  mounted() {
    ...
    // document.body.firstElementChild.style.backgroundColor = "rgba(0,0,0,.0)";
    console.log([document.body.firstElementChild.style]);
...
.activity_info {
  ...
  .content_a {
    ...
    width: 100%;
    height: 100%;
    background-image: url("https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=1670627962,3776336742&fm=11&gp=0.jpg") center;
    ...
    //   bottom: 0;
    //   left: 0;
    //   background: url("https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=1670627962,3776336742&fm=11&gp=0.jpg")
    //     center 0 no-repeat;
