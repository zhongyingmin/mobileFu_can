        ...
        <swiper :options="swiperOption" ref="mySwiper" class="area">
          <swiper-slide class="swiper-slide" v-show="state == 2">
            <div class="item_chunk" @click="goPath('/medicalSummary')">
              <div>
                <van-image width="100%" height="100%" src="../../static/image/zongjie.png" />
              </div>
              <div>病案总结</div>
            </div>
          </swiper-slide>
          <swiper-slide class="swiper-slide" v-show="state == 2">
            <div class="item_chunk" @click="goPath('/dataAnalysis')">
              <div>
                <van-image width="100%" height="100%" src="../../static/image/shuju.png" />
              </div>
              <div>数据分析</div>
            </div>
          </swiper-slide>
          <swiper-slide class="swiper-slide" v-show="state == 2">
            <div class="item_chunk" @click="goPath('/pharmacy')">
              <div>
                <van-image width="100%" height="100%" src="../../static/image/zhiyao.png" />
              </div>
              <div>制剂药房</div>
            </div>
          </swiper-slide>
          <swiper-slide class="swiper-slide">
            <div class="item_chunk" @click="goPath('/registerAppointment')">
              <div>
                <van-image width="100%" height="100%" src="../../static/image/yuyue.png" />
              </div>
              <div>挂号预约</div>
            </div>
          </swiper-slide>
          ...
          <swiper-slide class="swiper-slide">
            <div class="item_chunk" @click="goPath('/diagnosis')">
              <div>
                <van-image width="100%" height="100%" src="../../static/image/guwen.png" />
              </div>
              <div>诊疗通知</div>
            </div>
          </swiper-slide>
          <swiper-slide class="swiper-slide">
            <div class="item_chunk" @click="goPath('/attachedCopies')">
              <div>
                <van-image width="100%" height="100%" src="../../static/image/fujiance.png" />
              </div>
              <div>附件册</div>
            </div>
          </swiper-slide>
