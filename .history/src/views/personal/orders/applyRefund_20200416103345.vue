  ...
  <div class="applyRefund">
    ...
    <div class="applyRefund_main">
      ...
      <div class="a_instructions">
        <van-cell title="退款原因" is-link value="请选择" />
        <van-cell>
          <!-- 使用 title 插槽来自定义标题 -->
          <template #title>
        ...
        <van-cell title="不可修改，最多¥19.9，含发货包邮¥0.00" />
        <van-cell>
          <!-- 使用 title 插槽来自定义标题 -->
          <template #title>
            <span class="custom-title">退款说明:</span>
            <van-field v-model="message" rows="1" autosize type="textarea" placeholder="选填" />
          </template>
        </van-cell>
      </div>
    </div>
