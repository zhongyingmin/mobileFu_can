  ...
  <div class="info">
    ...
    <div class="info_main">
      ...
      <div class="m_item">
        ...
        <van-cell-group>
          <van-field v-model="value" @click="show=true" placeholder="选择省 / 市 / 区" right-icon="arrow-down"/>
        </van-cell-group>
        <van-cell-group>
          <van-field v-model="value" placeholder="请输入姓名" />
        </van-cell-group>
    ...
    <van-popup v-model="show" position="bottom" :style="{ height: '40%' }" @confirm="actiong">
