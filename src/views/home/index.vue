      ...
      <div class="home_head">
        <van-row class="head_dz">
          <van-col span="8">
            ...
            <div class="h_centers">上海<van-icon name="location-o" /></div>
          </van-col>
          <van-col span="8"><div class="h_center">首页</div></van-col>
        ...
        <swiper :options="swiperOption" ref="mySwiper" class="area">
          ...
          <swiper-slide class="swiper-slide" v-show="state == 2">
            <div class="item_chunk">数据分析</div>
          </swiper-slide>
          <swiper-slide class="swiper-slide" v-show="state == 2">
            <div class="item_chunk" @click="goPath('/pharmacy')">制剂药房</div>
          </swiper-slide>
          <swiper-slide class="swiper-slide">
            <div class="item_chunk">挂号预约</div>
          </swiper-slide>
          <swiper-slide class="swiper-slide">
          ...
          <swiper-slide class="swiper-slide">
            <div class="item_chunk">诊疗通知</div>
          </swiper-slide>
          <swiper-slide class="swiper-slide">
            <div class="item_chunk" @click="goPath('/attachedCopies')">附件册</div>
          </swiper-slide>
        </swiper>
      </div>
      <div class="h_summary">
              ...
              <thead class="r_table_head_h_thead">
                <tr class="r_table_head_h_thead_tr">
                  <th
                    colspan="1"
                    rowspan="1"
                    class="r_table_head_h_thead_th  t_text"
                  >
              ...
              <tbody class="r_table_head_h_tbody">
                ...
                >
                  <td
                    rowspan="1"
                    colspan="1"
                    class="r_table_body_t_main t_text "
                  >
        ...
        <div class="activity_main">
          ...
          <div class="activity_main_content">
            <div class="activity_main_content_head">
              <div class="activity_main_content_head_title">
                夏病冬治-百草药店膏方节
              </div>
            ...
            <div class="activity_main_content_head_text">
              <span>活动时间:</span><span>10月14日 8：00—10月15日15:00</span>
            </div>
          </div>
        </div>
      </div>
      <div class="recommended">
        <div class="recommended_head">
        ...
        <div class="recommended_main">
          <swiper
            :options="swiperOption_recommended"
            ref="recommended_mySwiper"
            class="area"
          >
            <swiper-slide class="swiper-slide">
              <div class="item_chunk">
                ...
                <div class="s_main">
                  <div class="s_main_head">
                    <div class="s_main_head_title">
                      中医药知识普及
                    </div>
                  </div>
                  <div class="s_main_head_text">
                    <span>文章</span><span>10月14日</span>
                  </div>
                </div>
              </div>
            </swiper-slide>
